...
* [Algorand Protocol Specs](https://github.com/algorandfoundation/specs) ⭐ 73 | 🐛 22 | 🌐 TeX | 📅 2026-09-02 - Protocol-level specification documents for the Algorand platform.
...
* [puya](https://github.com/algorandfoundation/puya) ⭐ 99 | 🐛 26 | 🌐 Python | 📅 2026-09-14 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
* [algokit-utils-ts](https://github.com/algorandfoundation/algokit-utils-ts) ⭐ 27 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-11 - Algorand AlgoKit Utils for TypeScript.
...
* [algokit-core](https://github.com/algorandfoundation/algokit-core) ⭐ 15 | 🐛 28 | 🌐 Rust | 📅 2026-09-11 - Multi-language core primitives (Rust + FFI bindings) powering higher-level AlgoKit tooling (crypto, encoding, protocol logic).
...
* [lazylora](https://github.com/aorumbayev/lazylora) ⭐ 13 | 🐛 1 | 🌐 Rust | 📅 2026-09-14 - Terminal UI for exploring Algorand blockchain.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,436 | 🐛 265 | 🌐 Go | 📅 2026-09-14 - Algorand's official implementation in Go.
...
* [py-algorand-sdk](https://github.com/algorand/py-algorand-sdk) ⭐ 274 | 🐛 14 | 🌐 Python | 📅 2026-08-21 - The Algorand Python SDK.
...
* [subtopia-js](https://github.com/subtopia-algo/subtopia-js) ⭐ 10 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-11 - Subtopia JavaScript SDK providing convenient interfaces to interact with Subtopia platform.
...
* [rust-algorand-sdk](https://github.com/manuelmauro/algonaut) ⭐ 70 | 🐛 20 | 🌐 Rust | 📅 2026-09-14 - Rust Algorand SDK.
...
* [swift-algokit](https://github.com/CorvidLabs/swift-algokit) ⭐ 2 | 🐛 2 | 🌐 Swift | 📅 2026-09-11 - AlgoKit utilities for Swift developers.
...
* [d-asa](https://github.com/cusma/d-asa) ⭐ 12 | 🐛 22 | 🌐 Python | 📅 2026-08-04 - Debt Algorand Standard Application providing reference implementations and interfaces for tokenizing debt instruments (bonds, loans, commercial papers) that conform to ACTUS standards.
...
* [swift-algotest](https://github.com/CorvidLabs/swift-algotest) ⭐ 2 | 🐛 1 | 🌐 Swift | 📅 2026-09-11 - Swift testing framework for Algorand smart contracts with mock chain support.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-14 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [nodekit](https://github.com/algorandfoundation/nodekit) ⭐ 55 | 🐛 17 | 🌐 Go | 📅 2026-09-11 - Terminal user interface for running and managing Algorand nodes locally.
