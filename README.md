...
* [puya](https://github.com/algorandfoundation/puya) ⭐ 97 | 🐛 25 | 🌐 Python | 📅 2026-08-14 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
* [algokit-utils-ts](https://github.com/algorandfoundation/algokit-utils-ts) ⭐ 27 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-13 - Algorand AlgoKit Utils for TypeScript.
* [algokit-utils-py](https://github.com/algorandfoundation/algokit-utils-py) ⭐ 19 | 🐛 24 | 🌐 Python | 📅 2026-08-14 - Algorand AlgoKit Utils for Python.
...
* [algorealm-ui](https://github.com/algorealm/algorealm-ui) ⭐ 3 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-14 - A web CLI Emulator version of algorealm cli game by @aorumbayev.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,432 | 🐛 269 | 🌐 Go | 📅 2026-08-15 - Algorand's official implementation in Go.
* [go-algorand-sdk](https://github.com/algorand/go-algorand-sdk) ⭐ 190 | 🐛 19 | 🌐 Go | 📅 2026-08-14 - The Algorand Golang SDK.
...
* [subtopia-js](https://github.com/subtopia-algo/subtopia-js) ⭐ 10 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-14 - Subtopia JavaScript SDK providing convenient interfaces to interact with Subtopia platform.
...
* [beaker](https://github.com/algorandfoundation/beaker) ⭐ 95 | 🐛 20 | 🌐 Python | 📅 2024-10-22 - Pythonic smart contract framework (PyTEAL DSL wrappers, client + testing utilities). (Canonical repo)
...
* [reti](https://github.com/algorandfoundation/reti) ⭐ 44 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-15 - Contracts, Node Daemon, and UI for Algorand 'The Reti' consensus incentives, enabling decentralized staking pools to broaden participation and enhance network security.
