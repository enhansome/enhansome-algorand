...
* [puya](https://github.com/algorandfoundation/puya) ⭐ 99 | 🐛 26 | 🌐 Python | 📅 2026-09-17 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
...
* [algokit-core](https://github.com/algorandfoundation/algokit-core) ⭐ 15 | 🐛 27 | 🌐 Rust | 📅 2026-09-17 - Multi-language core primitives (Rust + FFI bindings) powering higher-level AlgoKit tooling (crypto, encoding, protocol logic).
...
* [algonoderewards](https://github.com/cryptomalgo/algonoderewards) ⭐ 19 | 🐛 13 | 🌐 TypeScript | 📅 2025-12-31 - Track and visualize Algorand node rewards using Nodely API.
...
* [algorealm-ui](https://github.com/algorealm/algorealm-ui) ⭐ 3 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-19 - A web CLI Emulator version of algorealm cli game by @aorumbayev.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,437 | 🐛 272 | 🌐 Go | 📅 2026-09-19 - Algorand's official implementation in Go.
...
* [tinyman-py-sdk](https://github.com/tinymanorg/tinyman-py-sdk) ⭐ 119 | 🐛 7 | 🌐 Python | 📅 2026-06-05 - Tinyman Python SDK.
...
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 297 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-17 - The Algorand JavaScript SDK & Examples.
...
* [perawallet-connect](https://github.com/perawallet/connect) ⭐ 70 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-17 - JavaScript SDK for integrating Pera Wallet to web applications.
...
* [subtopia-js](https://github.com/subtopia-algo/subtopia-js) ⭐ 10 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-19 - Subtopia JavaScript SDK providing convenient interfaces to interact with Subtopia platform.
...
* [rust-algorand-sdk](https://github.com/manuelmauro/algonaut) ⭐ 71 | 🐛 20 | 🌐 Rust | 📅 2026-09-14 - Rust Algorand SDK.
...
* [d-asa](https://github.com/cusma/d-asa) ⭐ 13 | 🐛 22 | 🌐 Python | 📅 2026-08-04 - Debt Algorand Standard Application providing reference implementations and interfaces for tokenizing debt instruments (bonds, loans, commercial papers) that conform to ACTUS standards.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-19 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [reti](https://github.com/algorandfoundation/reti) ⭐ 44 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-20 - Contracts, Node Daemon, and UI for Algorand 'The Reti' consensus incentives, enabling decentralized staking pools to broaden participation and enhance network security.
...
* [ARC3](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0003.md) ⭐ 140 | 🐛 23 | 🌐 Python | 📅 2026-09-18 - Official Algorand Standard Asset Parameters Conventions for Fungible and Non-Fungible Tokens.
* [ARC32](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0032.md) ⭐ 140 | 🐛 23 | 🌐 Python | 📅 2026-09-18 - Application Specification.
* [ARC4](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0004.md) ⭐ 140 | 🐛 23 | 🌐 Python | 📅 2026-09-18 - Application Binary Interface.
* [ARC56](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0056.md) ⭐ 140 | 🐛 23 | 🌐 Python | 📅 2026-09-18 - Extended and improved Application Specification.
* [ARC69](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0069.md) ⭐ 140 | 🐛 23 | 🌐 Python | 📅 2026-09-18 - One of several Algorand Standard Asset Parameters Conventions.
