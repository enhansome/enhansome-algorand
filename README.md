...
* [puya](https://github.com/algorandfoundation/puya) ⭐ 97 | 🐛 26 | 🌐 Python | 📅 2026-08-13 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
* [algokit-utils-ts](https://github.com/algorandfoundation/algokit-utils-ts) ⭐ 27 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-12 - Algorand AlgoKit Utils for TypeScript.
* [algokit-utils-py](https://github.com/algorandfoundation/algokit-utils-py) ⭐ 19 | 🐛 29 | 🌐 Python | 📅 2026-08-10 - Algorand AlgoKit Utils for Python.
* [puya-ts](https://github.com/algorandfoundation/puya-ts) ⭐ 16 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-11 - An official TypeScript to TEAL compiler frontend, leveraging the core puya compiler, allows you to write code to execute on the Algorand Virtual Machine (AVM) with TypeScript syntax.
* [algokit-core](https://github.com/algorandfoundation/algokit-core) ⭐ 15 | 🐛 27 | 🌐 Rust | 📅 2026-08-12 - Multi-language core primitives (Rust + FFI bindings) powering higher-level AlgoKit tooling (crypto, encoding, protocol logic).
...
* [algorand-python-testing](https://github.com/algorandfoundation/algorand-python-testing) ⭐ 10 | 🐛 1 | 🌐 Python | 📅 2026-05-28 - A Python library for unit testing Algorand Python smart contracts without the need to interact with the Algorand Blockchain.
...
* [algorand-TypeScript-testing](https://github.com/algorandfoundation/algorand-TypeScript-testing) ⭐ 4 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-23 - A TypeScript library for unit testing Algorand smart contracts without the need to interact with the Algorand Blockchain.
...
* [Algorand School](https://github.com/cusma/algorand-school) ⭐ 82 | 🐛 1 | 📅 2023-10-25 - Crash course slide deck.
...
* [AlgoWorld-Contracts](https://github.com/algoworldNFT/algoworld-contracts) ⚠️ Archived - Collection of all smart contracts used by AlgoWorld, written in PyTeal.
...
* [wen-tools](https://github.com/LoafPickleWW/wen-tools) ⭐ 23 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-07 - Bulk operations tool for Algorand.
...
* [txnDuck](https://github.com/No-Cash-7970/txnDuck) ⭐ 19 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-07 - Transaction building tool for Algorand blockchain.
* [algonoderewards](https://github.com/cryptomalgo/algonoderewards) ⭐ 19 | 🐛 12 | 🌐 TypeScript | 📅 2025-12-31 - Track and visualize Algorand node rewards using Nodely API.
...
* [lazylora](https://github.com/aorumbayev/lazylora) ⭐ 13 | 🐛 6 | 🌐 Rust | 📅 2026-08-10 - Terminal UI for exploring Algorand blockchain.
* [TinyBar App](https://github.com/aorumbayev/tinybar) ⭐ 11 | 🐛 8 | 🌐 Python | 📅 2026-08-10 - A tiny macOS menu bar app for tracking ASA prices from TinyMan.
...
* [algorealm-ui](https://github.com/algorealm/algorealm-ui) ⭐ 3 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-13 - A web CLI Emulator version of algorealm cli game by @aorumbayev.
...
* [vertices-algorand-sdk](https://github.com/vertices-network/c-vertices-sdk) ⭐ 10 | 🐛 1 | 🌐 C | 📅 2021-11-18 - The Vertices SDK provides developers with easy device access to interact with Blockchains.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,432 | 🐛 269 | 🌐 Go | 📅 2026-08-13 - Algorand's official implementation in Go.
* [go-algorand-sdk](https://github.com/algorand/go-algorand-sdk) ⭐ 190 | 🐛 17 | 🌐 Go | 📅 2026-08-13 - The Algorand Golang SDK.
* [conduit](https://github.com/algorand/conduit) ⭐ 44 | 🐛 17 | 🌐 Go | 📅 2026-08-10 - Algorand's data pipeline framework.

#### PHP

* [algorand-php](https://github.com/RootSoft/algorand-php) ⭐ 42 | 🐛 5 | 🌐 PHP | 📅 2022-10-07 - Algorand PHP SDK created by [@RootSoft](https://github.com/RootSoft).
...
* [py-algorand-sdk](https://github.com/algorand/py-algorand-sdk) ⭐ 277 | 🐛 17 | 🌐 Python | 📅 2026-08-13 - The Algorand Python SDK.
* [tinyman-py-sdk](https://github.com/tinymanorg/tinyman-py-sdk) ⭐ 118 | 🐛 7 | 🌐 Python | 📅 2026-06-05 - Tinyman Python SDK.
...
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 298 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-12 - The Algorand JavaScript SDK & Examples.
...
* [perawallet-connect](https://github.com/perawallet/connect) ⭐ 70 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-13 - JavaScript SDK for integrating Pera Wallet to web applications.
...
* [subtopia-js](https://github.com/subtopia-algo/subtopia-js) ⭐ 10 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-07 - Subtopia JavaScript SDK providing convenient interfaces to interact with Subtopia platform.
...
* [java-algorand-sdk](https://github.com/algorand/java-algorand-sdk) ⭐ 73 | 🐛 62 | 🌐 Java | 📅 2026-08-12 - The Algorand Java SDK.

#### .NET

* [dotnet-algorand-sdk](https://github.com/RileyGe/dotnet-algorand-sdk) ⭐ 41 | 🐛 6 | 🌐 C# | 📅 2026-06-11 - Algorand .NET SDK created by [@RileyGe](https://github.com/RileyGe).
...
* [dotnet-alogrand-sdk (2)](https://github.com/FrankSzendzielarz/dotnet-algorand-sdk) ⭐ 29 | 🐛 6 | 🌐 C# | 📅 2024-05-19 - Algorand .NET SDK maintained by [@FrankSzendzielarz](https://github.com/FrankSzendzielarz).
...
* [swift-algokit](https://github.com/CorvidLabs/swift-algokit) ⭐ 2 | 🐛 2 | 🌐 Swift | 📅 2026-07-18 - AlgoKit utilities for Swift developers.
* [swift-algorand](https://github.com/CorvidLabs/swift-algorand) ⭐ 1 | 🐛 0 | 🌐 Swift | 📅 2026-07-14 - Modern Swift SDK for the Algorand Blockchain with async/await and Swift concurrency support.
* [swift-arc](https://github.com/CorvidLabs/swift-arc) ⭐ 1 | 🐛 0 | 🌐 Swift | 📅 2026-07-14 - Swift library for working with Algorand ARC metadata standards for NFTs.
* [swift-mint](https://github.com/CorvidLabs/swift-mint) ⭐ 1 | 🐛 1 | 🌐 Swift | 📅 2026-07-14 - Swift library for minting NFTs on the Algorand Blockchain.
* [swift-algochat](https://github.com/CorvidLabs/swift-algochat) ⭐ 1 | 🐛 0 | 🌐 Swift | 📅 2026-07-15 - End-to-end encrypted messaging on Algorand with hybrid ECDH and PSK ratcheting in Swift.
...
* [pyteal](https://github.com/algorand/pyteal) ⭐ 290 | 🐛 62 | 🌐 Python | 📅 2026-04-13 - Algorand Smart Contracts in Python.
...
* [beaker](https://github.com/algorandfoundation/beaker) ⭐ 94 | 🐛 20 | 🌐 Python | 📅 2024-10-22 - Pythonic smart contract framework (PyTEAL DSL wrappers, client + testing utilities). (Canonical repo)
...
* [d-asa](https://github.com/cusma/d-asa) ⭐ 10 | 🐛 22 | 🌐 Python | 📅 2026-08-04 - Debt Algorand Standard Application providing reference implementations and interfaces for tokenizing debt instruments (bonds, loans, commercial papers) that conform to ACTUS standards.
...
* [algojig](https://github.com/Hipo/algojig) ⭐ 17 | 🐛 6 | 🌐 Python | 📅 2025-05-15 - A tool for testing Algorand smart contracts.
...
* [swift-algotest](https://github.com/CorvidLabs/swift-algotest) ⭐ 2 | 🐛 2 | 🌐 Swift | 📅 2026-07-18 - Swift testing framework for Algorand smart contracts with mock chain support.
...
* [Liquid Auth](https://github.com/algorandfoundation/liquid-auth) ⭐ 32 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-12 - Self-hosted service to bind passkeys to crypto keypairs plus P2P signaling for secure peer connections.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-11 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [nodekit](https://github.com/algorandfoundation/nodekit) ⭐ 56 | 🐛 12 | 🌐 Go | 📅 2026-07-29 - Terminal user interface for running and managing Algorand nodes locally.
* [reti](https://github.com/algorandfoundation/reti) ⭐ 44 | 🐛 3 | 🌐 TypeScript | 📅 2026-04-03 - Contracts, Node Daemon, and UI for Algorand 'The Reti' consensus incentives, enabling decentralized staking pools to broaden participation and enhance network security.
...
* [algorand-mcp](https://github.com/GoPlausible/algorand-mcp) ⭐ 44 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-08 - Algorand Model Context Protocol (Server & Client) by GoPlausible.
* [algorand-agent-skills](https://github.com/algorand-devrel/algorand-agent-skills) ⭐ 33 | 🐛 2 | 🌐 Python | 📅 2026-06-24 - Canonical collection of Agent Skills for AI-assisted development on Algorand by Algorand DevRel.
* [VibeKit](https://github.com/gabrielkuettel/vibekit) ⭐ 26 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-21 - CLI + MCP server that gives AI coding assistants the skills and tools to build on Algorand.
...
* [corvid-agent](https://github.com/corvid-agent/corvid-agent) ⭐ 1 | 🐛 13 | 📅 2026-03-21 - An autonomous AI agent platform built on Algorand with encrypted on-chain messaging.
...
* [ARC3](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0003.md) ⭐ 140 | 🐛 20 | 🌐 Python | 📅 2026-08-04 - Official Algorand Standard Asset Parameters Conventions for Fungible and Non-Fungible Tokens.
* [ARC4](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0004.md) ⭐ 140 | 🐛 20 | 🌐 Python | 📅 2026-08-04 - Application Binary Interface.
* [ARC32](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0032.md) ⭐ 140 | 🐛 20 | 🌐 Python | 📅 2026-08-04 - Application Specification.
* [ARC56](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0056.md) ⭐ 140 | 🐛 20 | 🌐 Python | 📅 2026-08-04 - Extended and improved Application Specification.
* [ARC69](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0069.md) ⭐ 140 | 🐛 20 | 🌐 Python | 📅 2026-08-04 - One of several Algorand Standard Asset Parameters Conventions.

## Contributing

Contributions welcome! Read the [contribution guidelines](https://github.com/awesome-algorand/awesome-algorand/blob/main/contributing.md) ⭐ 218 | 🐛 5 | 📅 2026-06-30 first.
